...
var file_person_service_proto_rawDesc = []byte{
	...
	0x32, 0x8f, 0x01, 0x0a, 0x0d, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69,
...
var file_person_service_proto_depIdxs = []int32{
	4, // 0: CreatePersonRequest.person:type_name -> Person
	5, // 1: SearchPersonRequest.filter:type_name -> Filter
	4, // 2: SearchPersonResponse.person:type_name -> Person
	...
	1, // 5: PersonService.CreatePerson:output_type -> CreatePersonResponse
	3, // 6: PersonService.SearchPerson:output_type -> SearchPersonResponse
